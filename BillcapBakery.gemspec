...
Gem::Specification.new do |spec|
  spec.name          = "BillcapBakery"
  spec.version       = BillcapBakery::VERSION
  spec.authors       = ["antodoms"]
  spec.email         = ["antodoms@gmail.com"]

  spec.summary       = %q{Billcap }
  spec.description   = %q{Billcap }
  spec.homepage      = "https://github.com/antodoms/BillcapBakery"
  spec.license       = "MIT"
